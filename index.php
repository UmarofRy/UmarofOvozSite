<?php
define('API_KEY', '7482763065:AAEgp5gja2ep_aX6joiOn6rtroauqM2xMVk');
...
<body>
    ...
    <style>
        ...
        .loader {
            ...
            /* Yuklanish animatsiyasining fon rangi */
            display: flex;
        ...
        .loader::after {
            ...
            /* Yuklanish animatsiyasining turini ko'rsatadi */
